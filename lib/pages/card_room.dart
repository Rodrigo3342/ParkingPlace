...
import 'package:parkingplace/pages/room_detail.dart';
    ...
    final cardArrowFab = Positioned(
      ...
      child: FloatingActionButton(
        ...
        onPressed: (){
            Navigator.push(
            context,
              MaterialPageRoute(builder: (context) => RoomDetail(titleCard, "Este es uno de los estacionamientos que estan mas cerca de tu uicacion drisutalos!!!", pathImage)),
            );
        },
        child: Icon(
